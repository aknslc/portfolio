...
// photos
import photo1 from '../../../assets/img/projectsImage/projectImages1/1.png'
import photo2 from '../../../assets/img/projectsImage/projectImages1/2.png'
...
function ProjectModal1() {
    return (
        <>
            ...
            <div className="modal modal-lg fade" id="project1" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">E-commerce (Vanilla Js)</h5>
                        ...
                        <div className="modal-footer" >
                            ...
                            <a href='https://github.com/aknslc/javascript_ecommerce'>
